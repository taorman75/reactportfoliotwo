...
class Projects extends Component {
    ...
    toggleCategories() {
        ...
        return(
            ...
            <CardTitle style={{color: "#fff", height: "176px", background:`url(${portpic}) center / cover`}}>React Portfolio</CardTitle> 
                <CardText>
        ...
        return(
            <div className="projects-grid">
                <Card shadow={5} style={{minWidth: "450", margin: "auto"}}>
            <CardTitle style={{color: "#fff", height: "176px", background: `url(${empsyspic}) center / cover`}}>Employee Management System</CardTitle> 
                <CardText>
                This Node.js app allows a user to view, add, remove, and alter employee information sourced from a MySQL database. The app allows the user to view different combinations of employee information, utilizing SQL Joins.
            </CardText>
            <CardActions border>
            ...
            <Card shadow={5} style={{minWidth: "450", margin: "auto"}}>
            <CardTitle style={{color: "#fff", height: "176px", background: `url(${readmepic}) center / cover`}}>README Generator</CardTitle> 
                <CardText>
        ...
        return(
            <div className="projects-grid">
                <Card shadow={5} style={{minWidth: "450", margin: "auto"}}>
            <CardTitle style={{color: "black", height: "176px", background: `url(${donutpic}) center / cover`}}>Donut Seeker</CardTitle> 
                <CardText>
            ...
            <Card shadow={5} style={{minWidth: "450", margin: "auto"}}>
            <CardTitle style={{color: "black", height: "176px", background: `url(${weathpic}) center / cover`}}>Weather Dashboard</CardTitle> 
                <CardText>
        ...
        return(
            ...
            <CardActions border>
                ...
                <Button colored href="https://infinite-springs-66297.herokuapp.com" target="_blank">Live</Button>
            </CardActions>
            <CardMenu style={{color: "#fff"}}>
            </CardMenu>
            </Card>
